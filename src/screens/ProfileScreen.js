...
export default function ProfileScreen() {
  ...
  const handleShowDemographicsInfo = () => {
    Alert.alert(
      'Дата рождения и вес',
      'Заполнять необязательно. Но без этих данных фильтрация в статистике по возрасту и весу будет недоступна — сравнить себя с участиниками похожего возраста или веса не получится.',
    );
  };
