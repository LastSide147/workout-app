...
// введено. Все поля необязательные — пользователь мог их ещё не
// заполнить (тогда null, а не 0 — 0 выглядел бы как настоящее
// значение).
...
// Сохраняет дату рождения (год+месяц) и вес обычной записью с merge —
// это НЕ бакеты рейтинга, транзакция тут не нужна.
export async function saveProfileDemographics(userId, {birthYear, birthMonth, weight}) {
